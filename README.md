...
* An user  can order service,set a time limit,set a price. 

* They can also post reviews.

* Their reviews will be stored in MongoDB .By which the data is shown in the home page in review as the same thing in server.
...
## [Live](https://last-assignment-92136.web.app/)
