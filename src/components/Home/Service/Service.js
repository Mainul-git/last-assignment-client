...
const Service = ({service,setService}) => {
    ...
    return (
      <section className=" justify-content-center">
          <h1 className="" style={{display:'inline',marginLeft:'490px'}}>Provide</h1>
<h1 className="" style={{display:'inline',color:'#7AB259'}}> Services</h1>
            <div style={{textDecoration:'none'}} className="w-75 row d-flex offset-md-2 justify-content-center">
                {
